...
------:| ---:|----------|
 ...
 30 Apr| 2   | **Lecture:** ML Testing ([slides](./slides/06_ml_testing.pdf)). Recommended reading: *What’s your ML test score? A rubric for ML production systems.* [[1]](#1); also covering [[2]](#2) and [[3]](#3).
